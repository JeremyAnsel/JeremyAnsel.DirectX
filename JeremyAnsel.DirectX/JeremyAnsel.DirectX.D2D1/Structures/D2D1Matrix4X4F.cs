// <copyright file="D2D1Matrix4X4F.cs" company="Jérémy Ansel">
...
namespace JeremyAnsel.DirectX.D2D1
{
    ...
    public struct D2D1Matrix4X4F : IEquatable<D2D1Matrix4X4F>
    {
        ...
        /// <summary>
        /// Compares two <see cref="D2D1Matrix4X4F"/> objects. The result specifies whether the values of the two objects are equal.
        /// </summary>
        /// <param name="left">The left <see cref="D2D1Matrix4X4F"/> to compare.</param>
        /// <param name="right">The right <see cref="D2D1Matrix4X4F"/> to compare.</param>
        ...
        /// <summary>
        /// Compares two <see cref="D2D1Matrix4X4F"/> objects. The result specifies whether the values of the two objects are unequal.
        /// </summary>
        /// <param name="left">The left <see cref="D2D1Matrix4X4F"/> to compare.</param>
        /// <param name="right">The right <see cref="D2D1Matrix4X4F"/> to compare.</param>
        ...
        {
            if (obj is not D2D1Matrix4X4F)
            {
                return false;
            }

            return this.Equals((D2D1Matrix4X4F)obj);
        }
        ...
        /// <returns><value>true</value> if the specified object is equal to the current object; otherwise, <value>false</value>.</returns>
        public bool Equals(D2D1Matrix4X4F other)
        {

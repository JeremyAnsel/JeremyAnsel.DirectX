...
/// </summary>
[SkipLocalsInit]
public unsafe struct D2D1Matrix4X4F : IEquatable<D2D1Matrix4X4F>
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public static void NativeWriteTo(nint buffer, in D2D1Matrix4X4F obj)
    {
        fixed (void* ptr = &obj)
        {
            var span = new ReadOnlySpan<D2D1Matrix4X4F>(ptr, 1);
    ...
    {
        return obj is D2D1Matrix4X4F f && Equals(f);
    }

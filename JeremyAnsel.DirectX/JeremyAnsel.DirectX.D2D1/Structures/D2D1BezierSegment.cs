...
/// </summary>
[SkipLocalsInit]
public unsafe struct D2D1BezierSegment : IEquatable<D2D1BezierSegment>
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public static void NativeWriteTo(nint buffer, in D2D1BezierSegment obj)
    {
        fixed (void* ptr = &obj)
        {
            var span = new ReadOnlySpan<D2D1BezierSegment>(ptr, 1);
    ...
    {
        return obj is D2D1BezierSegment segment && Equals(segment);
    }

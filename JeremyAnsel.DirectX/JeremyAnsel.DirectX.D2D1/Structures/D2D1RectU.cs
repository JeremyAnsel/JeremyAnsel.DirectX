...
/// </summary>
[SkipLocalsInit]
public unsafe struct D2D1RectU : IEquatable<D2D1RectU>
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public static void NativeWriteTo(nint buffer, in D2D1RectU obj)
    {
        fixed (void* ptr = &obj)
        {
            var span = new ReadOnlySpan<D2D1RectU>(ptr, 1);
    ...
    public static void NativeWriteTo(nint buffer, ReadOnlySpan<D2D1RectU> objects)
    {
    ...
    /// <param name="buffer"></param>
    /// <returns></returns>
    public static D2D1RectU NativeReadFrom(nint buffer)
    {
        D2D1RectU obj;
    ...
    /// <param name="buffer"></param>
    /// <param name="objects"></param>
    public static void NativeReadFrom(nint buffer, Span<D2D1RectU> objects)
    {
    ...
    {
        return obj is D2D1RectU u && Equals(u);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(D2D1RectU other)
    {

...
namespace JeremyAnsel.DirectX.D2D1.ComInterfaces
{
    ...
    internal interface ID2D1BitmapRenderTarget
    {
        /// <summary>
        ...
        /// <param name="pitch">The byte count of each scanline, which is equal to (the image width in pixels × the number of bytes per pixel) + memory padding. If <paramref name="srcData"/> is NULL, this value is ignored. (Note that pitch is also sometimes called stride.)</param>

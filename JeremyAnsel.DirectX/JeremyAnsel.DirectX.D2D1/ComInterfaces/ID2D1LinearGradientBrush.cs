...
internal unsafe readonly struct ID2D1LinearGradientBrush
{
    ...
    public readonly delegate* unmanaged[Stdcall]<nint, float, float, void> SetStartPoint;
    ...
    public readonly delegate* unmanaged[Stdcall]<nint, float, float, void> SetEndPoint;

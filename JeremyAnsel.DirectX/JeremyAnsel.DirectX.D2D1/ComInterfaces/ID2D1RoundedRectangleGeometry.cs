// <copyright file="ID2D1RoundedRectangleGeometry.cs" company="Jérémy Ansel">
...
internal unsafe readonly struct ID2D1RoundedRectangleGeometry
{
    ...
    /// </summary>
    /// <param name="roundedRect">A rounded rectangle that describes this rounded rectangle geometry.</param>
    public readonly delegate* unmanaged[Stdcall]<nint, void*, void> GetRoundedRect;
}

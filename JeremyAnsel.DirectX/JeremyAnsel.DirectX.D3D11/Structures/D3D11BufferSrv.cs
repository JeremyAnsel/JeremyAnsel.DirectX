...
/// </summary>
[SkipLocalsInit]
public unsafe struct D3D11BufferSrv : IEquatable<D3D11BufferSrv>
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public static void NativeWriteTo(nint buffer, in D3D11BufferSrv obj)
    {
        fixed (void* ptr = &obj)
        {
            var span = new ReadOnlySpan<D3D11BufferSrv>(ptr, 1);
    ...
    {
        return obj is D3D11BufferSrv srv && Equals(srv);
    }

...
/// </summary>
[SkipLocalsInit]
public unsafe struct D3D11Texture1DArrayRtv : IEquatable<D3D11Texture1DArrayRtv>
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public static void NativeWriteTo(nint buffer, in D3D11Texture1DArrayRtv obj)
    {
        fixed (void* ptr = &obj)
        {
            var span = new ReadOnlySpan<D3D11Texture1DArrayRtv>(ptr, 1);
    ...
    public static void NativeWriteTo(nint buffer, ReadOnlySpan<D3D11Texture1DArrayRtv> objects)
    {
    ...
    /// <param name="buffer"></param>
    /// <returns></returns>
    public static D3D11Texture1DArrayRtv NativeReadFrom(nint buffer)
    {
        D3D11Texture1DArrayRtv obj;
    ...
    /// <param name="buffer"></param>
    /// <param name="objects"></param>
    public static void NativeReadFrom(nint buffer, Span<D3D11Texture1DArrayRtv> objects)
    {
    ...
    public D3D11Texture1DArrayRtv(uint mipSlice, uint firstArraySlice, uint arraySize)
    {
    ...
    {
        return obj is D3D11Texture1DArrayRtv rtv && Equals(rtv);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(D3D11Texture1DArrayRtv other)
    {

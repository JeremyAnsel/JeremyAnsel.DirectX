...
namespace JeremyAnsel.DirectX.D3D11
{
    ...
    public struct D3D11Texture2DMsArrayDsv : IEquatable<D3D11Texture2DMsArrayDsv>
    {
        /// <summary>
        ...
        /// <summary>
        /// Compares two <see cref="D3D11Texture2DMsArrayDsv"/> objects. The result specifies whether the values of the two objects are equal.
        /// </summary>
        /// <param name="left">The left <see cref="D3D11Texture2DMsArrayDsv"/> to compare.</param>
        /// <param name="right">The right <see cref="D3D11Texture2DMsArrayDsv"/> to compare.</param>
        ...
        /// <summary>
        /// Compares two <see cref="D3D11Texture2DMsArrayDsv"/> objects. The result specifies whether the values of the two objects are unequal.
        /// </summary>
        /// <param name="left">The left <see cref="D3D11Texture2DMsArrayDsv"/> to compare.</param>
        /// <param name="right">The right <see cref="D3D11Texture2DMsArrayDsv"/> to compare.</param>
        ...
        {
            if (obj is not D3D11Texture2DMsArrayDsv)
            {
                return false;
            }

            return this.Equals((D3D11Texture2DMsArrayDsv)obj);
        }
        ...
        /// <returns><value>true</value> if the specified object is equal to the current object; otherwise, <value>false</value>.</returns>
        public bool Equals(D3D11Texture2DMsArrayDsv other)
        {

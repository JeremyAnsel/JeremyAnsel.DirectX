...
namespace JeremyAnsel.DirectX.D3D11
{
    ...
    public struct D3D11Texture1DDesc : IEquatable<D3D11Texture1DDesc>
    {
        ...
        /// <summary>
        /// Compares two <see cref="D3D11Texture1DDesc"/> objects. The result specifies whether the values of the two objects are equal.
        /// </summary>
        /// <param name="left">The left <see cref="D3D11Texture1DDesc"/> to compare.</param>
        /// <param name="right">The right <see cref="D3D11Texture1DDesc"/> to compare.</param>
        ...
        /// <summary>
        /// Compares two <see cref="D3D11Texture1DDesc"/> objects. The result specifies whether the values of the two objects are unequal.
        /// </summary>
        /// <param name="left">The left <see cref="D3D11Texture1DDesc"/> to compare.</param>
        /// <param name="right">The right <see cref="D3D11Texture1DDesc"/> to compare.</param>
        ...
        {
            if (obj is not D3D11Texture1DDesc)
            {
                return false;
            }

            return this.Equals((D3D11Texture1DDesc)obj);
        }

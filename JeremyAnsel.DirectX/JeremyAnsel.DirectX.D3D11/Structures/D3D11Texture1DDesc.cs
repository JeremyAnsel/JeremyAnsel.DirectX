// <copyright file="D3D11Texture1DDesc.cs" company="Jérémy Ansel">
...
/// </summary>
[SkipLocalsInit]
public unsafe struct D3D11Texture1DDesc : IEquatable<D3D11Texture1DDesc>
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public static void NativeWriteTo(nint buffer, in D3D11Texture1DDesc obj)
    {
        fixed (void* ptr = &obj)
        {
            var span = new ReadOnlySpan<D3D11Texture1DDesc>(ptr, 1);
    ...
    public static void NativeWriteTo(nint buffer, ReadOnlySpan<D3D11Texture1DDesc> objects)
    {
    ...
    /// <param name="buffer"></param>
    /// <returns></returns>
    public static D3D11Texture1DDesc NativeReadFrom(nint buffer)
    {
        D3D11Texture1DDesc obj;
    ...
    /// <param name="buffer"></param>
    /// <param name="objects"></param>
    public static void NativeReadFrom(nint buffer, Span<D3D11Texture1DDesc> objects)
    {
    ...
    {
        return obj is D3D11Texture1DDesc desc && Equals(desc);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(D3D11Texture1DDesc other)
    {

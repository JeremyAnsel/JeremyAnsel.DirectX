...
/// </summary>
[SkipLocalsInit]
public unsafe struct D3D11Texture2DSrv : IEquatable<D3D11Texture2DSrv>
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public static void NativeWriteTo(nint buffer, in D3D11Texture2DSrv obj)
    {
        fixed (void* ptr = &obj)
        {
            var span = new ReadOnlySpan<D3D11Texture2DSrv>(ptr, 1);
    ...
    public static void NativeWriteTo(nint buffer, ReadOnlySpan<D3D11Texture2DSrv> objects)
    {
    ...
    /// <param name="buffer"></param>
    /// <returns></returns>
    public static D3D11Texture2DSrv NativeReadFrom(nint buffer)
    {
        D3D11Texture2DSrv obj;
    ...
    /// <param name="buffer"></param>
    /// <param name="objects"></param>
    public static void NativeReadFrom(nint buffer, Span<D3D11Texture2DSrv> objects)
    {
    ...
    public D3D11Texture2DSrv(uint mostDetailedMip, uint mipLevels)
    {
    ...
    {
        return obj is D3D11Texture2DSrv srv && Equals(srv);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(D3D11Texture2DSrv other)
    {

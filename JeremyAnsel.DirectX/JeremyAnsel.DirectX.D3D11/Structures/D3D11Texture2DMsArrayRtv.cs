...
namespace JeremyAnsel.DirectX.D3D11
{
    ...
    public struct D3D11Texture2DMsArrayRtv : IEquatable<D3D11Texture2DMsArrayRtv>
    {
        /// <summary>
        ...
        /// <summary>
        /// Compares two <see cref="D3D11Texture2DMsArrayRtv"/> objects. The result specifies whether the values of the two objects are equal.
        /// </summary>
        /// <param name="left">The left <see cref="D3D11Texture2DMsArrayRtv"/> to compare.</param>
        /// <param name="right">The right <see cref="D3D11Texture2DMsArrayRtv"/> to compare.</param>
        ...
        /// <summary>
        /// Compares two <see cref="D3D11Texture2DMsArrayRtv"/> objects. The result specifies whether the values of the two objects are unequal.
        /// </summary>
        /// <param name="left">The left <see cref="D3D11Texture2DMsArrayRtv"/> to compare.</param>
        /// <param name="right">The right <see cref="D3D11Texture2DMsArrayRtv"/> to compare.</param>
        ...
        {
            if (obj is not D3D11Texture2DMsArrayRtv)
            {
                return false;
            }

            return this.Equals((D3D11Texture2DMsArrayRtv)obj);
        }
        ...
        /// <returns><value>true</value> if the specified object is equal to the current object; otherwise, <value>false</value>.</returns>
        public bool Equals(D3D11Texture2DMsArrayRtv other)
        {

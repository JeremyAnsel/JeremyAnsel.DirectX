...
/// </summary>
[SkipLocalsInit]
public unsafe struct D3D11Texture2DMsArraySrv : IEquatable<D3D11Texture2DMsArraySrv>
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public static void NativeWriteTo(nint buffer, in D3D11Texture2DMsArraySrv obj)
    {
        fixed (void* ptr = &obj)
        {
            var span = new ReadOnlySpan<D3D11Texture2DMsArraySrv>(ptr, 1);
    ...
    public static void NativeWriteTo(nint buffer, ReadOnlySpan<D3D11Texture2DMsArraySrv> objects)
    {
    ...
    /// <param name="buffer"></param>
    /// <returns></returns>
    public static D3D11Texture2DMsArraySrv NativeReadFrom(nint buffer)
    {
        D3D11Texture2DMsArraySrv obj;
    ...
    /// <param name="buffer"></param>
    /// <param name="objects"></param>
    public static void NativeReadFrom(nint buffer, Span<D3D11Texture2DMsArraySrv> objects)
    {
    ...
    public D3D11Texture2DMsArraySrv(uint firstArraySlice, uint arraySize)
    {
    ...
    {
        return obj is D3D11Texture2DMsArraySrv srv && Equals(srv);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(D3D11Texture2DMsArraySrv other)
    {

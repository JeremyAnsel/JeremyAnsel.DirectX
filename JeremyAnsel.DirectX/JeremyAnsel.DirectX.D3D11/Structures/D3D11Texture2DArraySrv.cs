...
/// </summary>
[SkipLocalsInit]
public unsafe struct D3D11Texture2DArraySrv : IEquatable<D3D11Texture2DArraySrv>
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public static void NativeWriteTo(nint buffer, in D3D11Texture2DArraySrv obj)
    {
        fixed (void* ptr = &obj)
        {
            var span = new ReadOnlySpan<D3D11Texture2DArraySrv>(ptr, 1);
    ...
    public static void NativeWriteTo(nint buffer, ReadOnlySpan<D3D11Texture2DArraySrv> objects)
    {
    ...
    /// <param name="buffer"></param>
    /// <returns></returns>
    public static D3D11Texture2DArraySrv NativeReadFrom(nint buffer)
    {
        D3D11Texture2DArraySrv obj;
    ...
    /// <param name="buffer"></param>
    /// <param name="objects"></param>
    public static void NativeReadFrom(nint buffer, Span<D3D11Texture2DArraySrv> objects)
    {
    ...
    public D3D11Texture2DArraySrv(uint mostDetailedMip, uint mipLevels, uint firstArraySlice, uint arraySize)
    {
    ...
    {
        return obj is D3D11Texture2DArraySrv srv && Equals(srv);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(D3D11Texture2DArraySrv other)
    {

// <copyright file="D3D11TextureCubeSrv.cs" company="Jérémy Ansel">
...
/// </summary>
[SkipLocalsInit]
public unsafe struct D3D11TextureCubeSrv : IEquatable<D3D11TextureCubeSrv>
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public static void NativeWriteTo(nint buffer, in D3D11TextureCubeSrv obj)
    {
        fixed (void* ptr = &obj)
        {
            var span = new ReadOnlySpan<D3D11TextureCubeSrv>(ptr, 1);
    ...
    public static void NativeWriteTo(nint buffer, ReadOnlySpan<D3D11TextureCubeSrv> objects)
    {
    ...
    /// <param name="buffer"></param>
    /// <returns></returns>
    public static D3D11TextureCubeSrv NativeReadFrom(nint buffer)
    {
        D3D11TextureCubeSrv obj;
    ...
    /// <param name="buffer"></param>
    /// <param name="objects"></param>
    public static void NativeReadFrom(nint buffer, Span<D3D11TextureCubeSrv> objects)
    {
    ...
    public D3D11TextureCubeSrv(uint mostDetailedMip, uint mipLevels)
    {
    ...
    /// <returns></returns>
    public static bool operator ==(D3D11TextureCubeSrv left, D3D11TextureCubeSrv right)
    {
    ...
    {
        return obj is D3D11TextureCubeSrv srv && Equals(srv);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(D3D11TextureCubeSrv other)
    {

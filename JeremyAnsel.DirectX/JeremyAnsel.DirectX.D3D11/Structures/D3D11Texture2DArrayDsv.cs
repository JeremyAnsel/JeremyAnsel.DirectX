...
/// </summary>
[SkipLocalsInit]
public unsafe struct D3D11Texture2DArrayDsv : IEquatable<D3D11Texture2DArrayDsv>
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public static void NativeWriteTo(nint buffer, in D3D11Texture2DArrayDsv obj)
    {
        fixed (void* ptr = &obj)
        {
            var span = new ReadOnlySpan<D3D11Texture2DArrayDsv>(ptr, 1);
    ...
    public static void NativeWriteTo(nint buffer, ReadOnlySpan<D3D11Texture2DArrayDsv> objects)
    {
    ...
    /// <param name="buffer"></param>
    /// <returns></returns>
    public static D3D11Texture2DArrayDsv NativeReadFrom(nint buffer)
    {
        D3D11Texture2DArrayDsv obj;
    ...
    /// <param name="buffer"></param>
    /// <param name="objects"></param>
    public static void NativeReadFrom(nint buffer, Span<D3D11Texture2DArrayDsv> objects)
    {
    ...
    public D3D11Texture2DArrayDsv(uint mipSlice, uint firstArraySlice, uint arraySize)
    {
    ...
    {
        return obj is D3D11Texture2DArrayDsv dsv && Equals(dsv);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(D3D11Texture2DArrayDsv other)
    {

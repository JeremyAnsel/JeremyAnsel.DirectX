// <copyright file="D3D11Texture2DArrayRtv.cs" company="Jérémy Ansel">
...
/// </summary>
[SkipLocalsInit]
public unsafe struct D3D11Texture2DArrayRtv : IEquatable<D3D11Texture2DArrayRtv>
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public static void NativeWriteTo(nint buffer, in D3D11Texture2DArrayRtv obj)
    {
        fixed (void* ptr = &obj)
        {
            var span = new ReadOnlySpan<D3D11Texture2DArrayRtv>(ptr, 1);
    ...
    public static void NativeWriteTo(nint buffer, ReadOnlySpan<D3D11Texture2DArrayRtv> objects)
    {
    ...
    /// <param name="buffer"></param>
    /// <returns></returns>
    public static D3D11Texture2DArrayRtv NativeReadFrom(nint buffer)
    {
        D3D11Texture2DArrayRtv obj;
    ...
    /// <param name="buffer"></param>
    /// <param name="objects"></param>
    public static void NativeReadFrom(nint buffer, Span<D3D11Texture2DArrayRtv> objects)
    {
    ...
    public D3D11Texture2DArrayRtv(uint mipSlice, uint firstArraySlice, uint arraySize)
    {
    ...
    /// <returns></returns>
    public static bool operator ==(D3D11Texture2DArrayRtv left, D3D11Texture2DArrayRtv right)
    {
    ...
    {
        return obj is D3D11Texture2DArrayRtv rtv && Equals(rtv);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(D3D11Texture2DArrayRtv other)
    {

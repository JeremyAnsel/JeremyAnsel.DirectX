...
namespace JeremyAnsel.DirectX.D3D11
{
    ...
    public struct D3D11Texture1DArraySrv : IEquatable<D3D11Texture1DArraySrv>
    {
        /// <summary>
        ...
        /// <summary>
        /// Compares two <see cref="D3D11Texture1DArraySrv"/> objects. The result specifies whether the values of the two objects are equal.
        /// </summary>
        /// <param name="left">The left <see cref="D3D11Texture1DArraySrv"/> to compare.</param>
        /// <param name="right">The right <see cref="D3D11Texture1DArraySrv"/> to compare.</param>
        ...
        /// <summary>
        /// Compares two <see cref="D3D11Texture1DArraySrv"/> objects. The result specifies whether the values of the two objects are unequal.
        /// </summary>
        /// <param name="left">The left <see cref="D3D11Texture1DArraySrv"/> to compare.</param>
        /// <param name="right">The right <see cref="D3D11Texture1DArraySrv"/> to compare.</param>
        ...
        {
            if (obj is not D3D11Texture1DArraySrv)
            {
                return false;
            }

            return this.Equals((D3D11Texture1DArraySrv)obj);
        }
        ...
        /// <returns><value>true</value> if the specified object is equal to the current object; otherwise, <value>false</value>.</returns>
        public bool Equals(D3D11Texture1DArraySrv other)
        {

// <copyright file="D3D11Texture2DArrayUav.cs" company="Jérémy Ansel">
...
/// </summary>
[SkipLocalsInit]
public unsafe struct D3D11Texture2DArrayUav : IEquatable<D3D11Texture2DArrayUav>
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public static void NativeWriteTo(nint buffer, in D3D11Texture2DArrayUav obj)
    {
        fixed (void* ptr = &obj)
        {
            var span = new ReadOnlySpan<D3D11Texture2DArrayUav>(ptr, 1);
    ...
    public static void NativeWriteTo(nint buffer, ReadOnlySpan<D3D11Texture2DArrayUav> objects)
    {
    ...
    /// <param name="buffer"></param>
    /// <returns></returns>
    public static D3D11Texture2DArrayUav NativeReadFrom(nint buffer)
    {
        D3D11Texture2DArrayUav obj;
    ...
    /// <param name="buffer"></param>
    /// <param name="objects"></param>
    public static void NativeReadFrom(nint buffer, Span<D3D11Texture2DArrayUav> objects)
    {
    ...
    public D3D11Texture2DArrayUav(uint mipSlice, uint firstArraySlice, uint arraySize)
    {
    ...
    /// <returns></returns>
    public static bool operator ==(D3D11Texture2DArrayUav left, D3D11Texture2DArrayUav right)
    {
    ...
    {
        return obj is D3D11Texture2DArrayUav uav && Equals(uav);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(D3D11Texture2DArrayUav other)
    {

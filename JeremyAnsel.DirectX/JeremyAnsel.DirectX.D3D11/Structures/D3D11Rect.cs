...
namespace JeremyAnsel.DirectX.D3D11
{
    ...
    public struct D3D11Rect : IEquatable<D3D11Rect>
    {
        ...
        /// <summary>
        /// Compares two <see cref="D3D11Rect"/> objects. The result specifies whether the values of the two objects are equal.
        /// </summary>
        /// <param name="left">The left <see cref="D3D11Rect"/> to compare.</param>
        /// <param name="right">The right <see cref="D3D11Rect"/> to compare.</param>
        ...
        /// <summary>
        /// Compares two <see cref="D3D11Rect"/> objects. The result specifies whether the values of the two objects are unequal.
        /// </summary>
        /// <param name="left">The left <see cref="D3D11Rect"/> to compare.</param>
        /// <param name="right">The right <see cref="D3D11Rect"/> to compare.</param>
        ...
        {
            if (obj is not D3D11Rect)
            {
                return false;
            }

            return this.Equals((D3D11Rect)obj);
        }

// <copyright file="D3D11Texture1DSrv.cs" company="Jérémy Ansel">
...
/// </summary>
[SkipLocalsInit]
public unsafe struct D3D11Texture1DSrv : IEquatable<D3D11Texture1DSrv>
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public static void NativeWriteTo(nint buffer, in D3D11Texture1DSrv obj)
    {
        fixed (void* ptr = &obj)
        {
            var span = new ReadOnlySpan<D3D11Texture1DSrv>(ptr, 1);
    ...
    public static void NativeWriteTo(nint buffer, ReadOnlySpan<D3D11Texture1DSrv> objects)
    {
    ...
    /// <param name="buffer"></param>
    /// <returns></returns>
    public static D3D11Texture1DSrv NativeReadFrom(nint buffer)
    {
        D3D11Texture1DSrv obj;
    ...
    /// <param name="buffer"></param>
    /// <param name="objects"></param>
    public static void NativeReadFrom(nint buffer, Span<D3D11Texture1DSrv> objects)
    {
    ...
    public D3D11Texture1DSrv(uint mostDetailedMip, uint mipLevels)
    {
    ...
    /// <returns></returns>
    public static bool operator ==(D3D11Texture1DSrv left, D3D11Texture1DSrv right)
    {
    ...
    {
        return obj is D3D11Texture1DSrv srv && Equals(srv);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(D3D11Texture1DSrv other)
    {

...
[SkipLocalsInit]
public unsafe class D3D11Texture1D : D3D11Resource
{
    /// <summary>
    /// The interface GUID.
    /// </summary>
    public static readonly Guid D3D11Texture1DGuid = typeof(ID3D11Texture1D).GUID;

    private readonly nint _comPtr;
    private readonly ID3D11Texture1D* _comImpl;
    ...
    {
        _comPtr = comPtr;
        _comImpl = *(ID3D11Texture1D**)comPtr;
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="D3D11Texture1D"/> class.
    /// </summary>
    /// <param name="resource">A ressource interface which implements the <c>ID3D11Texture1D</c> interface.</param>
    public static D3D11Texture1D CreateTexture1DFromRessource(DXComObject resource)
    {
        return CreateTexture1DFromRessource(resource.Handle);
    }
    ...
    public static D3D11Texture1D CreateTexture1DFromRessource(nint resource)
    {
        ...
        nint ptr = DXUtils.QueryInterface(resource, D3D11Texture1DGuid);
    ...
    public D3D11Texture1DDesc Description
    {
        get
        {
            ...
            return D3D11Texture1DDesc.NativeReadFrom((nint)ptr);
        }
    }

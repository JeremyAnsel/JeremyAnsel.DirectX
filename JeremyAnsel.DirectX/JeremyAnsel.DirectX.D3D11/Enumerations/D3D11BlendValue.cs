...
public enum D3D11BlendValue
{
    ...
    /// <summary>
    /// The blend factor is the blend factor set with <see cref="D3D11DeviceContext.OutputMergerSetBlendState(D3D11BlendState, float[], uint)"/>. No pre-blend operation.
    /// </summary>
    BlendFactor = 14,

    /// <summary>
    /// The blend factor is the blend factor set with <see cref="D3D11DeviceContext.OutputMergerSetBlendState(D3D11BlendState, float[], uint)"/>. The pre-blend operation inverts the blend factor, generating <c>1 - blend_factor</c>.
    /// </summary>

...
[SkipLocalsInit]
public unsafe class DxgiAdapter3 : DxgiObject
{
    /// <summary>
    /// The interface GUID.
    /// </summary>
    public static readonly Guid DxgiAdapter3Guid = typeof(IDxgiAdapter2).GUID;
    ...
    /// </summary>
    /// <returns>An IEnumerable of <see cref="DxgiOutput3"/>.</returns>
    ...
    {
        nint parent = GetParent(DxgiFactory3.DxgiFactory3Guid);
        return new DxgiFactory3(parent);
    }
}

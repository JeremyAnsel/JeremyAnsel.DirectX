...
/// </summary>
[SkipLocalsInit]
public unsafe struct DxgiAdapterDesc : IEquatable<DxgiAdapterDesc>
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public static void NativeWriteTo(nint buffer, in DxgiAdapterDesc obj)
    {
        fixed (void* ptr = &obj)
        {
            var span = new ReadOnlySpan<DxgiAdapterDesc>(ptr, 1);
    ...
    public static void NativeWriteTo(nint buffer, ReadOnlySpan<DxgiAdapterDesc> objects)
    {
    ...
    /// <param name="buffer"></param>
    /// <returns></returns>
    public static DxgiAdapterDesc NativeReadFrom(nint buffer)
    {
        DxgiAdapterDesc obj;
    ...
    /// <param name="buffer"></param>
    /// <param name="objects"></param>
    public static void NativeReadFrom(nint buffer, Span<DxgiAdapterDesc> objects)
    {
    ...
    {
        return obj is DxgiAdapterDesc desc && Equals(desc);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(DxgiAdapterDesc other)
    {
        fixed (char* ptrThis = adapterDescription.Buffer)
        {

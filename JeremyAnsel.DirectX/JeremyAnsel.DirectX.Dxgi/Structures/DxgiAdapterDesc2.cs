// <copyright file="DxgiAdapterDesc2.cs" company="Jérémy Ansel">
...
namespace JeremyAnsel.DirectX.Dxgi
{
    ...
    public struct DxgiAdapterDesc2 : IEquatable<DxgiAdapterDesc2>
    {
        ...
        /// </summary>
        private readonly DxgiGraphicsPreemptionGranularity graphicsPreemptionGranularity;
        ...
        /// </summary>
        private readonly DxgiComputePreemptionGranularity computePreemptionGranularity;
        ...
        /// <summary>
        /// Compares two <see cref="DxgiAdapterDesc2"/> objects. The result specifies whether the values of the two objects are equal.
        /// </summary>
        /// <param name="left">The left <see cref="DxgiAdapterDesc2"/> to compare.</param>
        /// <param name="right">The right <see cref="DxgiAdapterDesc2"/> to compare.</param>
        ...
        /// <summary>
        /// Compares two <see cref="DxgiAdapterDesc2"/> objects. The result specifies whether the values of the two objects are unequal.
        /// </summary>
        /// <param name="left">The left <see cref="DxgiAdapterDesc2"/> to compare.</param>
        /// <param name="right">The right <see cref="DxgiAdapterDesc2"/> to compare.</param>
        ...
        {
            if (obj is not DxgiAdapterDesc2)
            {
                return false;
            }

            return this.Equals((DxgiAdapterDesc2)obj);
        }
        ...
        public bool Equals(DxgiAdapterDesc2 other)
        {
            return this.adapterDescription == other.adapterDescription
                ...
                && this.graphicsPreemptionGranularity == other.graphicsPreemptionGranularity
                && this.computePreemptionGranularity == other.computePreemptionGranularity;
        }
        ...
        public override int GetHashCode()
        {
            return new
            {
                ...
                this.adapterLuid,
                this.adapterType,
                this.graphicsPreemptionGranularity,
                this.computePreemptionGranularity
            }
            .GetHashCode();
        }
    }

...
[SkipLocalsInit]
public unsafe class DxgiOutput3 : DxgiObject
{
    /// <summary>
    /// The interface GUID.
    /// </summary>
    public static readonly Guid DxgiOutput3Guid = typeof(IDxgiOutput2).GUID;

    private readonly nint _comPtr;
    private readonly IDxgiOutput2* _comImpl;
    ...
    public bool SupportsOverlays
    {
        get
        {
            return _comImpl->SupportsOverlays(_comPtr) != 0;
        }
    }

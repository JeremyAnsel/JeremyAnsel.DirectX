// <copyright file="DxgiSurface3.cs" company="Jérémy Ansel">
...
[SkipLocalsInit]
public unsafe class DxgiSurface3 : DxgiDeviceSubObject
{
    /// <summary>
    /// The interface GUID.
    /// </summary>
    public static readonly Guid DxgiSurface3Guid = typeof(IDxgiSurface2).GUID;

    private readonly nint _comPtr;
    private readonly IDxgiSurface2* _comImpl;

    /// <summary>
    /// Initializes a new instance of the <see cref="DxgiSurface3"/> class.
    /// </summary>
    ...
    public static DxgiSurface3 CreateSurfaceFromResource(nint resource)
    {
        ...
        nint ptr = DXUtils.QueryInterface(resource, DxgiSurface3Guid);

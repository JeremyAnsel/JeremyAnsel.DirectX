...
namespace JeremyAnsel.DirectX.DWrite
{
    ...
    public struct DWriteRect : IEquatable<DWriteRect>
    {
        ...
        /// <summary>
        /// Compares two <see cref="DWriteRect"/> objects. The result specifies whether the values of the two objects are equal.
        /// </summary>
        /// <param name="left">The left <see cref="DWriteRect"/> to compare.</param>
        /// <param name="right">The right <see cref="DWriteRect"/> to compare.</param>
        ...
        /// <summary>
        /// Compares two <see cref="DWriteRect"/> objects. The result specifies whether the values of the two objects are unequal.
        /// </summary>
        /// <param name="left">The left <see cref="DWriteRect"/> to compare.</param>
        /// <param name="right">The right <see cref="DWriteRect"/> to compare.</param>
        ...
        {
            if (obj is not DWriteRect)
            {
                return false;
            }

            return this.Equals((DWriteRect)obj);
        }

// <copyright file="DWriteRect.cs" company="Jérémy Ansel">
...
/// </summary>
[SkipLocalsInit]
public unsafe struct DWriteRect : IEquatable<DWriteRect>
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public static void NativeWriteTo(nint buffer, in DWriteRect obj)
    {
        fixed (void* ptr = &obj)
        {
            var span = new ReadOnlySpan<DWriteRect>(ptr, 1);
    ...
    public static void NativeWriteTo(nint buffer, ReadOnlySpan<DWriteRect> objects)
    {
    ...
    /// <param name="buffer"></param>
    /// <returns></returns>
    public static DWriteRect NativeReadFrom(nint buffer)
    {
        DWriteRect obj;
    ...
    /// <param name="buffer"></param>
    /// <param name="objects"></param>
    public static void NativeReadFrom(nint buffer, Span<DWriteRect> objects)
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DWriteRect"/> struct.
    /// </summary>
    ...
    {
        return obj is DWriteRect rect && Equals(rect);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(DWriteRect other)
    {

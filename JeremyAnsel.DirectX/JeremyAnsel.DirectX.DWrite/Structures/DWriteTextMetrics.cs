...
namespace JeremyAnsel.DirectX.DWrite
{
    ...
    public struct DWriteTextMetrics : IEquatable<DWriteTextMetrics>
    {
        ...
        /// </summary>
        private readonly float widthIncludingTrailingWhitespace;
        ...
        /// </summary>
        private readonly float layoutHeight;
        ...
        /// </summary>
        private readonly uint maxBidiReorderingDepth;

        /// <summary>
        /// Total number of lines.
        /// </summary>
        private readonly uint lineCount;
        ...
        {
            if (obj is not DWriteTextMetrics)
            {
                return false;
            }

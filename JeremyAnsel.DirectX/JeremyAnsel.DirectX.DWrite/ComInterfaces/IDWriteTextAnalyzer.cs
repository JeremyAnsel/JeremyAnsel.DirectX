...
internal unsafe readonly struct IDWriteTextAnalyzer
{
    ...
    public readonly delegate* unmanaged[Stdcall]<nint, nint, uint, uint, nint, int> AnalyzeScript;
    ...
    /// </remarks>
    public readonly delegate* unmanaged[Stdcall]<nint, nint, uint, uint, nint, int> AnalyzeBidi;
    ...
    /// Embedded control codes (LRE/LRO/RLE/RLO/PDF) are taken into account.
    /// </remarks>
    public readonly delegate* unmanaged[Stdcall]<nint, nint, uint, uint, nint, int> AnalyzeNumberSubstitution;
    ...
    /// </remarks>
    public readonly delegate* unmanaged[Stdcall]<nint, nint, uint, uint, nint, int> AnalyzeLineBreakpoints;
    ...
    /// </remarks>
    public readonly delegate* unmanaged[Stdcall]<nint, char*, uint, nint, int, int, void*, char*, nint, nint, uint*, uint, uint, ushort*, void*, ushort*, void*, uint*, int> GetGlyphs;
    ...
    public readonly delegate* unmanaged[Stdcall]<nint, char*, ushort*, void*, uint, ushort*, void*, uint, nint, float, int, int, void*, char*, nint, uint*, uint, float*, void*, int> GetGlyphPlacements;
    ...
    /// <param name="glyphAdvances">The advance width of each glyph.</param>
    /// <param name="glyphOffsets">The offset of the origin of each glyph.</param>
    public readonly delegate* unmanaged[Stdcall]<nint, char*, ushort*, void*, uint, ushort*, void*, uint, nint, float, float, nint, int, int, int, void*, char*, nint, uint*, uint, float*, void*, int> GetGdiCompatibleGlyphPlacements;
}

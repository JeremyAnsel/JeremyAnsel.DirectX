...
internal unsafe readonly struct IDWriteFontCollection
{
    ...
    public readonly delegate* unmanaged[Stdcall]<nint, uint> GetFontFamilyCount;
    ...
    public readonly delegate* unmanaged[Stdcall]<nint, uint, nint*, int> GetFontFamily;
    ...
    /// </remarks>
    public readonly delegate* unmanaged[Stdcall]<nint, char*, uint*, int*, int> FindFontFamily;
    ...
    /// </remarks>
    public readonly delegate* unmanaged[Stdcall]<nint, nint, nint*, int> GetFontFromFontFace;
}

...
internal unsafe readonly struct IDWriteFontFileStream
{
    ...
    /// </remarks>
    public readonly delegate* unmanaged[Stdcall]<nint, nint*, ulong, ulong, nint*, int> ReadFileFragment;

    /// <summary>
    /// Releases a fragment from a file.
    /// </summary>
    /// <param name="fragmentContext">The client defined context of a font fragment returned from ReadFileFragment.</param>
    public readonly delegate* unmanaged[Stdcall]<nint, nint, void> ReleaseFileFragment;
    ...
    /// </remarks>
    public readonly delegate* unmanaged[Stdcall]<nint, ulong*, int> GetFileSize;
    ...
    /// </remarks>
    public readonly delegate* unmanaged[Stdcall]<nint, ulong*, int> GetLastWriteTime;
}

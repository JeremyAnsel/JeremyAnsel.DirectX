// <copyright file="IDWriteFontFace.cs" company="Jérémy Ansel">
...
internal unsafe readonly struct IDWriteFontFace
{
    ...
    /// </summary>
    /// <returns><see cref="DWriteFontFaceType"/></returns>
    public readonly delegate* unmanaged[Stdcall]<nint, DWriteFontFaceType> GetFaceType;
    ...
    public readonly delegate* unmanaged[Stdcall]<nint, uint*, nint*, int> GetFiles;
    ...
    public readonly delegate* unmanaged[Stdcall]<nint, uint> GetIndex;
    ...
    /// </summary>
    /// <param name="fontFaceMetrics">Points to a <see cref="DWriteFontMetrics"/> structure to fill in.
    ...
    public readonly delegate* unmanaged[Stdcall]<nint, ushort> GetGlyphCount;
    ...
    public readonly delegate* unmanaged[Stdcall]<nint, ushort*, uint, void*, int, int> GetDesignGlyphMetrics;
    ...
    public readonly delegate* unmanaged[Stdcall]<nint, uint*, uint, ushort*, int> GetGlyphIndices;
    ...
    /// </remarks>
    public readonly delegate* unmanaged[Stdcall]<nint, uint, nint*, uint*, nint*, int*, int> TryGetFontTable;

    /// <summary>
    /// Releases the table obtained earlier from TryGetFontTable.
    /// </summary>
    /// <param name="tableContext">Opaque context from TryGetFontTable.</param>
    public readonly delegate* unmanaged[Stdcall]<nint, nint, void> ReleaseFontTable;
    ...
    public readonly delegate* unmanaged[Stdcall]<nint, float, ushort*, float*, void*, uint, int, int, nint, int> GetGlyphRunOutline;
    ...
    public readonly delegate* unmanaged[Stdcall]<nint, float, float, DWriteMeasuringMode, nint, DWriteRenderingMode*, int> GetRecommendedRenderingMode;
    ...
    /// The metrics returned by this function are in font design units.</param>
    public readonly delegate* unmanaged[Stdcall]<nint, float, float, void*, void*, int> GetGdiCompatibleMetrics;
    ...
    /// </remarks>
    public readonly delegate* unmanaged[Stdcall]<nint, float, float, void*, int, ushort*, uint, void*, int, int> GetGdiCompatibleGlyphMetrics;
}

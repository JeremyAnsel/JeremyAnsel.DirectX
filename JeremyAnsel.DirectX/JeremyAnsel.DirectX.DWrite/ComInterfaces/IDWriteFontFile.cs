...
internal unsafe readonly struct IDWriteFontFile
{
    ...
    public readonly delegate* unmanaged[Stdcall]<nint, nint*, uint*, int> GetReferenceKey;

    /// <summary>
    /// Obtains the file loader associated with a font file object.
    /// </summary>
    /// <param name="fontFileLoader">The font file loader associated with the font file object.</param>
    public readonly delegate* unmanaged[Stdcall]<nint, nint*, int> GetLoader;
    ...
    /// </remarks>
    public readonly delegate* unmanaged[Stdcall]<nint, int*, DWriteFontFileType*, DWriteFontFaceType*, uint*, int> Analyse;
}

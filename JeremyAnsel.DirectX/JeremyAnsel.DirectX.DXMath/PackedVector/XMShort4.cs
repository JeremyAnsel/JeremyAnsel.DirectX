...
public unsafe struct XMShort4 : IEquatable<XMShort4>
{
    ...
    /// <param name="array">The components of the vector.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XMShort4(ReadOnlySpan<short> array)
    {
        if (array.Length != 4)
        {
            throw new ArgumentOutOfRangeException(nameof(array));
    ...
    /// <param name="array">The components of the vector.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XMShort4(ReadOnlySpan<float> array)
    {
        this = XMVector.LoadFloat4(new XMFloat4(array));
    }
    ...
    {
        return obj is XMShort4 @short && Equals(@short);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(XMShort4 other)
    {
        return x == other.x &&
               y == other.y &&
               z == other.z &&

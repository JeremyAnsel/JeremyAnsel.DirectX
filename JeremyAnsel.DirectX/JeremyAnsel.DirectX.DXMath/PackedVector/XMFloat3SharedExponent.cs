...
public unsafe struct XMFloat3SharedExponent : IEquatable<XMFloat3SharedExponent>
{
    ...
    /// <param name="array">The components of the vector.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XMFloat3SharedExponent(ReadOnlySpan<float> array)
    {
        this = XMVector.LoadFloat3(new XMFloat3(array));
    }
    ...
    {
        return obj is XMFloat3SharedExponent exponent && Equals(exponent);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(XMFloat3SharedExponent other)
    {
        return v == other.v;
    }

...
public unsafe struct XMShortN4 : IEquatable<XMShortN4>
{
    ...
    /// <param name="array">The components of the vector.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XMShortN4(ReadOnlySpan<short> array)
    {
        if (array.Length != 4)
        {
            throw new ArgumentOutOfRangeException(nameof(array));
    ...
    /// <param name="array">The components of the vector.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XMShortN4(ReadOnlySpan<float> array)
    {
        this = XMVector.LoadFloat4(new XMFloat4(array));
    }
    ...
    {
        return obj is XMShortN4 n && Equals(n);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(XMShortN4 other)
    {
        return x == other.x &&
               y == other.y &&
               z == other.z &&

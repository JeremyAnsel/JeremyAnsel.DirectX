...
public unsafe struct XMUShort2 : IEquatable<XMUShort2>
{
    ...
    /// <param name="array">The components of the vector.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XMUShort2(ReadOnlySpan<ushort> array)
    {
        if (array.Length != 2)
        {
            throw new ArgumentOutOfRangeException(nameof(array));
    ...
    /// <param name="array">The components of the vector.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XMUShort2(ReadOnlySpan<float> array)
    {
        this = XMVector.LoadFloat2(new XMFloat2(array));
    }
    ...
    {
        return obj is XMUShort2 @short && Equals(@short);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(XMUShort2 other)
    {
        return x == other.x &&
               y == other.y;
    }

...
public unsafe struct XMUByteN2 : IEquatable<XMUByteN2>
{
    ...
    /// <param name="array">The components of the vector.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XMUByteN2(ReadOnlySpan<byte> array)
    {
        if (array.Length != 2)
        {
            throw new ArgumentOutOfRangeException(nameof(array));
    ...
    /// <param name="array">The components of the vector.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XMUByteN2(ReadOnlySpan<float> array)
    {
        this = XMVector.LoadFloat2(new XMFloat2(array));
    }
    ...
    {
        return obj is XMUByteN2 n && Equals(n);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(XMUByteN2 other)
    {
        return x == other.x &&
               y == other.y;
    }

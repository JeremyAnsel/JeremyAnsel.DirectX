...
public struct XMUNibble4 : IEquatable<XMUNibble4>
{
    ...
    /// <param name="array">The components of the vector.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XMUNibble4(ReadOnlySpan<byte> array)
    {
        if (array.Length != 4)
        {
            throw new ArgumentOutOfRangeException(nameof(array));
    ...
    /// <param name="array">The components of the vector.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XMUNibble4(ReadOnlySpan<float> array)
    {
        this = XMVector.LoadFloat4(new XMFloat4(array));
    }
    ...
    {
        return obj is XMUNibble4 nibble && Equals(nibble);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(XMUNibble4 other)
    {
        return v == other.v;
    }

...
public unsafe struct XMHalf4 : IEquatable<XMHalf4>
{
    ...
    /// <param name="array">The components of the vector.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XMHalf4(ReadOnlySpan<Half> array)
    {
        if (array.Length != 4)
        {
            throw new ArgumentOutOfRangeException(nameof(array));
    ...
    /// <param name="array">The components of the vector.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XMHalf4(ReadOnlySpan<float> array)
    {
        if (array.Length != 4)
        {
            throw new ArgumentOutOfRangeException(nameof(array));
    ...
    {
        return obj is XMHalf4 half && Equals(half);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(XMHalf4 other)
    {

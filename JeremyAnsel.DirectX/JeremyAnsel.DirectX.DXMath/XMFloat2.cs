...
/// </summary>
[SkipLocalsInit]
public struct XMFloat2 : IFormattable, IEquatable<XMFloat2>
{
    /// <summary>
    ...
    /// <param name="array">The components of the vector.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XMFloat2(ReadOnlySpan<float> array)
    {
        if (array.Length != 2)
        {
            throw new ArgumentOutOfRangeException(nameof(array));
    ...
    {
        return obj is XMFloat2 @float && Equals(@float);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(XMFloat2 other)
    {
        return x == other.x &&
               y == other.y;
    }

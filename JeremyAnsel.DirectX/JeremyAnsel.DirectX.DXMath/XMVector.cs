...
/// </summary>
[SkipLocalsInit]
public unsafe struct XMVector : IFormattable, IEquatable<XMVector>
{
    /// <summary>
    /// The x component.
    /// </summary>
    ...
    /// <param name="array">The components.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XMVector(ReadOnlySpan<float> array)
    {
        if (array.Length != 4)
        {
            throw new ArgumentOutOfRangeException(nameof(array));
    ...
    /// <param name="array">The components.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XMVector(ReadOnlySpan<int> array)
    {
        if (array.Length != 4)
        {
            throw new ArgumentOutOfRangeException(nameof(array));
    ...
    /// <param name="array">The components.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XMVector(ReadOnlySpan<uint> array)
    {
        if (array.Length != 4)
        {
            throw new ArgumentOutOfRangeException(nameof(array));
    ...
    /// <param name="array">The components.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XMVector(ReadOnlySpan<byte> array)
    {
        if (array.Length != 16)
        {
            throw new ArgumentOutOfRangeException(nameof(array));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [SuppressMessage("Usage", "CA2225:Les surcharges d'opérateur offrent d'autres méthodes nommées", Justification = "Reviewed.")]
    public static implicit operator ReadOnlySpan<float>(XMVector value)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [SuppressMessage("Usage", "CA2225:Les surcharges d'opérateur offrent d'autres méthodes nommées", Justification = "Reviewed.")]
    public static implicit operator Span<float>(XMVector value)
    {
        return value.AsSpan();
    }
    ...
    /// <returns>Returns a vector, each of whose components is either 0.0f or 1.0f.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XMVector FromBinaryConstant(ReadOnlySpan<uint> constants)
    {
        if (constants.Length != 4)
        {
            throw new ArgumentOutOfRangeException(nameof(constants));
    ...
    /// <returns>Returns a vector.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XMVector LoadInt2(ReadOnlySpan<uint> source)
    {
        if (source.Length != 2)
        {
            throw new ArgumentOutOfRangeException(nameof(source));
    ...
    /// <returns>Returns a vector.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XMVector LoadInt3(ReadOnlySpan<uint> source)
    {
        if (source.Length != 3)
        {
            throw new ArgumentOutOfRangeException(nameof(source));
    ...
    /// <returns>Returns a vector.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XMVector LoadInt4(ReadOnlySpan<uint> source)
    {
        if (source.Length != 4)
        {
            throw new ArgumentOutOfRangeException(nameof(source));
    ...
    /// <returns>Returns the control vector.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XMVector SelectControl(ReadOnlySpan<uint> indexes)
    {
        if (indexes.Length != 4)
        {
            throw new ArgumentOutOfRangeException(nameof(indexes));
    ...
    public ReadOnlySpan<float> AsReadOnlySpan()
    {
        fixed (void* ptr = &this)
        {
            return new ReadOnlySpan<float>(ptr, 4);
        }
    }
    ...
    [SuppressMessage("Microsoft.Design", "CA1021:AvoidOutParameters", MessageId = "0#", Justification = "Reviewed")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void StoreInt2(Span<uint> destination)
    {
        ...
        destination[0] = this.IntX;
        destination[1] = this.IntY;
    }
    ...
    [SuppressMessage("Microsoft.Design", "CA1021:AvoidOutParameters", MessageId = "0#", Justification = "Reviewed")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void StoreInt3(Span<uint> destination)
    {
    ...
    [SuppressMessage("Microsoft.Design", "CA1021:AvoidOutParameters", MessageId = "0#", Justification = "Reviewed")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void StoreInt4(Span<uint> destination)
    {
    ...
    /// <returns>Returns the swizzled vector.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XMVector Swizzle(ReadOnlySpan<XMSwizzle> elements)
    {
        if (elements.Length != 4)
        {
            throw new ArgumentOutOfRangeException(nameof(elements));
    ...
    {
        return obj is XMVector vector && Equals(vector);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(XMVector other)
    {
        return x == other.x &&
               y == other.y &&
               z == other.z &&

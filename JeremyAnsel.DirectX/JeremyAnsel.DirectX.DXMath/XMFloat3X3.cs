...
public unsafe struct XMFloat3X3 : IEquatable<XMFloat3X3>
{
    ...
    /// <param name="array">The values of the matrix.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XMFloat3X3(ReadOnlySpan<float> array)
    {
        if (array.Length != 9)
        {
            throw new ArgumentOutOfRangeException(nameof(array));
    ...
    {
        value.StoreFloat3X3(out XMFloat3X3 ret);
        return ret;
    }
    ...
    {
        return obj is XMFloat3X3 x && Equals(x);
    }
    ...
    /// <returns></returns>
    public readonly bool Equals(XMFloat3X3 other)
    {

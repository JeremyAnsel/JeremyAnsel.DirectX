// <copyright file="XMFloat4X3.cs" company="Jérémy Ansel">
...
namespace JeremyAnsel.DirectX.DXMath
{
    ...
    public unsafe struct XMFloat4X3 : IEquatable<XMFloat4X3>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="XMFloat4X3"/> struct.
        /// </summary>
        ...
        /// <summary>
        /// Converts a <see cref="XMFloat4X3"/> to a <see cref="XMMatrix"/>.
        /// </summary>
        /// <param name="value">A <see cref="XMFloat4X3"/>.</param>
        /// <returns>A <see cref="XMMatrix"/>.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [SuppressMessage("Usage", "CA2225:Les surcharges d'opérateur offrent d'autres méthodes nommées", Justification = "Reviewed.")]
        public static implicit operator XMMatrix(XMFloat4X3 value)
        {
            return XMMatrix.LoadFloat4X3(value);
        }

        /// <summary>
        /// Converts a <see cref="XMMatrix"/> to a <see cref="XMFloat4X3"/>.
        /// </summary>
        /// <param name="value">A <see cref="XMMatrix"/>.</param>
        /// <returns>A <see cref="XMFloat4X3"/>.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [SuppressMessage("Usage", "CA2225:Les surcharges d'opérateur offrent d'autres méthodes nommées", Justification = "Reviewed.")]
        public static implicit operator XMFloat4X3(XMMatrix value)
        {
            value.StoreFloat4X3(out XMFloat4X3 ret);
            return ret;
        }

        /// <summary>
        /// Compares two <see cref="XMFloat4X3"/> objects. The result specifies whether the values of the two objects are equal.
        /// </summary>
        /// <param name="left">The left <see cref="XMFloat4X3"/> to compare.</param>
        /// <param name="right">The right <see cref="XMFloat4X3"/> to compare.</param>
        ...
        /// <summary>
        /// Compares two <see cref="XMFloat4X3"/> objects. The result specifies whether the values of the two objects are unequal.
        /// </summary>
        /// <param name="left">The left <see cref="XMFloat4X3"/> to compare.</param>
        /// <param name="right">The right <see cref="XMFloat4X3"/> to compare.</param>
        ...
        {
            if (!(obj is XMFloat4X3))
            {
                return false;
            }

            return this.Equals((XMFloat4X3)obj);
        }

// <copyright file="WicImageParameters.cs" company="Jérémy Ansel">
...
public struct WicImageParameters : IEquatable<WicImageParameters>
{
    ...
    public WicImageParameters(in WicD2D1PixelFormat pixelFormat, float dpiX, float dpiY, float top, float left, uint width, uint height)
    {
